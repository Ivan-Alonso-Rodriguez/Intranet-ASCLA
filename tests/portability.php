...
$checks=[
    ...
    'schema_version'=>get_option('ascla_schema')==2,
...
echo wp_json_encode(['wordpress'=>$GLOBALS['wp_version'],'plugin'=>ASCLA_VERSION,'php'=>PHP_VERSION,'checks'=>$checks,'intranet'=>ASCLA\Core\Domain\Catalog::url('intranet')],JSON_PRETTY_PRINT)."\n";
