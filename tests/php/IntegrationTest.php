...

{
    ...
    public function testAIEnrichesTheOriginalResourceWithoutCreatingDerivedPosts(): void
    {
        $p=$this->make('resource',['meta'=>['resource_type'=>'Video','chatham'=>true,'transcript'=>"[00:00] Persona Prueba explica la supervisión de riesgos en Compañía Privada.
[01:10] Los acuerdos requieren responsables y seguimiento.",'identities'=>"Persona Prueba
Compañía Privada"]]);
