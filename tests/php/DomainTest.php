...
final class DomainTest extends TestCase
{
    ...
    public function testChathamRedactsKnownIdentityAndAffiliation(): void
    {
        ...
        self::assertStringNotContainsString('example.invalid',$redacted);self::assertStringContainsString('decisión',$redacted);
    ...
    public function testMocksNeverInventStatisticsOrSources(): void
    {
        ...
        self::assertCount(3,$result['excerpts']);foreach($result['excerpts'] as $clip){self::assertGreaterThanOrEqual(60,$clip['end']-$clip['start']);self::assertLessThanOrEqual(180,$clip['end']-$clip['start']);}
