...
## Versión actual: 1.9.50 · esquema 10

La versión 1.9.50 mejora dos comportamientos cotidianos de la Intranet. Las imágenes y archivos seleccionados para un formulario se mantienen **temporales** hasta que la operación se guarda; si el usuario cancela, cierra o reemplaza la selección, ASCLA los descarta y no aparecen en la biblioteca de archivos. Además, las interacciones relevantes pueden mostrarse como **toast** en la esquina inferior derecha mediante REST + polling cada 7 segundos, manteniendo siempre la notificación persistente en la campana. No usa WebSockets ni sonido y se mantiene el esquema 10.
