...
final class Messaging
{
    ...
    public static function send(int $id,string $body): array
    {
        ...
        Notifications::send((int)$other['user_id'],'message','Tienes un nuevo mensaje.',Catalog::url('mensajeria',['conversation'=>$id]),['type'=>'conversation','id'=>$id,'actor'=>get_current_user_id()]);
