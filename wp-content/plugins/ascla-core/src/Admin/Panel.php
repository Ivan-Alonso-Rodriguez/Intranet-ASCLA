...
final class Panel
{
    public static function boot(): void
    {
        add_action('admin_menu',static function () {
            ...
            $caps=['Importar intereses'=>'ascla_manage','Estadísticas'=>'ascla_publish','Dashboard'=>'ascla_admin_area','IA'=>'ascla_admin_area','Microeventos'=>'ascla_publish','Logs'=>'ascla_manage','Miembros'=>'ascla_manage','Integraciones'=>'ascla_manage','Configuración'=>'ascla_manage','Eventos'=>'ascla_publish','Conocimiento'=>'ascla_publish','Galería'=>'ascla_publish'];
