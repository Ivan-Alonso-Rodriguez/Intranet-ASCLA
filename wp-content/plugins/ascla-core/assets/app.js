  ...
  async function start() {
    try {
      ...
      if (S.page === "admin") {
        ...
        S.adminTab = q.get("section") ||
          {
            "ascla-miembros": "usuarios",
            "ascla-solicitudes": "solicitudes",
            "ascla-estadisticas": "estadisticas",
            "ascla-importar-intereses": "importar",
            "ascla-ia": "trabajos",
