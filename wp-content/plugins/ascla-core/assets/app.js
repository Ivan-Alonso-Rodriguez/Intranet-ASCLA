...
(() => {
  ...
  function shell() {
    ...
    const adminLink = (S.boot.moderator || S.boot.executive) ? `<a class="nav-link" href="${E(C.adminUrl)}">${I("settings")}Administración</a>` : "";
