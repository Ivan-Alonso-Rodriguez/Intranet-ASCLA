...
> **Versión actual:** `1.9.28`  
> **Esquema de base de datos:** `7`  
> La versión `1.9.28` incorpora palabras clave como señal secundaria en las recomendaciones del Centro de Conocimiento, manteniendo los intereses explícitos del perfil como criterio principal y usando la recencia únicamente como desempate de contenido ya relevante. Mantiene el esquema de datos 7.
...
| 1.9.27 | Resumen editorial, duración verificada y estados visibles | **Actual** |
