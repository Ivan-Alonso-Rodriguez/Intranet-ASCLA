...
## Versión actual: 1.9.28 · esquema 7

La versión 1.9.28 mantiene el esquema 7 y mejora las recomendaciones del Centro de Conocimiento: los intereses explícitos del perfil siguen siendo la señal principal, mientras que las palabras clave generadas/revisadas del recurso ayudan como señal secundaria cuando coinciden con intereses, áreas de conocimiento, industrias u objetivos del asociado. La recencia solo desempata contenido ya relevante y no recomienda recursos ajenos por sí sola.
